...
const QuoteContent = () => {
  ...
  return (
    ...
    <div>
        {/***********************************
        Content body start************************************/}
      <div className="content-body" style={{ minHeight: 720 }}>
          ...
          <div className="row">
                ...
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="total-projects ms-3">
                      <h3 className="text-success">652</h3>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="total-projects ms-3">
                      <h3 className="text-primary">132</h3>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="total-projects ms-3">
                      <h3 className="text-purple">528</h3>
                      <span>Lambris interieur</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="total-projects ms-3">
                      <h3 className="text-danger">54</h3>
                      <span>Parquet interieur</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="total-projects ms-3">
                      <h3 className="text-purple">528</h3>
                      <span>Solivage et plancher</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-sm-6">
              <div className="card">
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="icon-box icon-box-lg bg-danger-light rounded-circle"></div>
                    <div className="total-projects ms-3">
                      <h3 className="text-danger count">54</h3>
                      <span>Portes interieures</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-xl-12">
            <div className="card">
              <div className="card-body p-0">
                <div className="col-xl-12">
                  <div className="card dz-card" id="accordion-four">
                    <div className="card-header flex-wrap d-flex justify-content-between">
                      <div>
                        <h4 className="card-title">Liste des devis</h4>
                      </div>
                    </div>
                    {/* /tab-content */}
                    <div className="tab-content" id="myTabContent-3">
                      ...
                      <div
                        ...
                        aria-labelledby="home-tab-3"
                      >
                        <div className="card-body pt-0 p-0 code-area"></div>
                      </div>
                    </div>
                    {/* /tab-content */}
