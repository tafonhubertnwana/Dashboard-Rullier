                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div className="total-projects ms-3">
                        <h3 className="text-success count">652</h3>
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div className="total-projects ms-3">
                        <h3 className="text-primary count">132</h3>
                        <span>Total commnde</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div className="total-projects ms-3">
                        <h3 className="text-purple count">528</h3>
                        <span>Total de devis</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div className="total-projects ms-3">
                        ...
                        <span>Total devis abandoné</span>
                      </div>
                    </div>
                  </div>
                </div>
